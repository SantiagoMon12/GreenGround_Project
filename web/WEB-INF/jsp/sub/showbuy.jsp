    ...
    <body>
        <section>
            <h1><c:out value="${size}"></c:out></h1>
                ...
                <form method="POST" action="/pdfdown">
                <center><a href="/pdfdown?idusu=${id}"><button class="boton3"><i class="fas fa-file-pdf"></i> Descargue su orden de compra <i class="fas fa-file-download"></i></button></a><br></center><br><br><br>
